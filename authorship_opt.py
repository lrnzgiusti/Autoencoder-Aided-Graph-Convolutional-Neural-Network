...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 22:13:09 2021
...
learningRateDecayRate = 0.99 # Rate
learningRateDecayPeriod = 10 # How many epochs after which update the lr
...
if doGraphLearnGNN:
    ...
    # Pooling
    modelGLGNN['nSelectedNodes'] = [100, 100] # Number of nodes to keep
    ...
    #\\\ HPARAMS
    multipliers = { "lambda" : [0.0, 5e-4], #Frob
                    "gamma" :  [0.0, 3e-4], #Log-B
                    "beta" :   [1e-5, 0.0], #TV
                    "eta" :    [5e-5, 6e-5]} # Enc-Dec
    print(multipliers)
...
if doSelectionGNN:
    ...
    # Pooling
    modelSelGNN['nSelectedNodes'] = [100, 100] # Number of nodes to keep
    modelSelGNN['poolingFunction'] = gml.MaxPoolLocal # Summarizing function
    modelSelGNN['poolingSize'] = [2, 4] # Summarizing neighborhoods
    # Readout layer
...
if doAggregationGNN:
    ...
    modelAggGNN['dimFeatures'] = [1, 32, 64, 128] # Number of features per layer
    modelAggGNN['nFilterTaps'] = [6, 4, 4] # Number of filter taps
    ...
    modelAggGNN['poolingSize'] = [2, 2, 2] # Summarizing neighborhoods
    # Readout layer
...
if doMultinodeGNN:
    ...
    modelMultiGNN['nSelectedNodes'] = [30, 10]
    modelMultiGNN['nShifts'] = [5, 5]
...
for split in range(nDataSplits):
    ...
    for thisModel in modelList:
        ...
        # ARCHITECTURE #
        ################
        comp_ratio = int(sys.argv[2]) 
        modelDict['nSelectedNodes'] = [int(nNodes//comp_ratio), int(nNodes//comp_ratio)]
